...
const [t53_1_1, setName] = useState('click btn');
  ...
  const handleChange = (prop, event) => {
    ...
    function t74_1_2(index) {
      ...
      const lastName1 = "Рустемов";
      const firstName1 = "Эдем";
      const patronymic1 = "Асанович";
      const salary1 = "50000";
    
      const lastName2 = "Асанов";
      const firstName2 = "Алим";
      const patronymic2 = "Шевкетович";
      const salary2 = "60000";
    
      const lastName3 = "Петров";
      const firstName3 = "Петр";
      const patronymic3 = "Петрович";
      const salary3 = "55000";
...
<div>
    ...
    <div>
      ...
      <h1>81.1</h1>
      <div>
        <Employee lastName="Рустемов" firstName="Эдем" patronymic="Асанович" salary="50000" />
        <Employee lastName="Асанов" firstName="Алим" patronymic="Шевкетович" salary="60000" />
        <Employee lastName="Петров" firstName="Петр" patronymic="Петрович" salary="55000" />
      </div>
